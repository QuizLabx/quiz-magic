...
// 🎭 شخصية النظام الثابتة (الافتراضية) — تظهر في مشهد نهاية المعركة لمن لم يشترِ شخصية
const DEFAULT_CHARACTER = {
  id: 'character_default',
  price: 0,
  name: { ar: 'مهرج البطاقات', en: 'Card Jester' },
  image: 'assets/images/store/characters/character_default.png'
};

// 🛡️ اسم الحارس في الساحة (يظهر كشخصية الفائز عند خسارة اللاعب)
const ARENA_GUARDIAN_NAME = { ar: 'حارس الساحة', en: 'Arena Guardian' };

/**
 * 🎭 إرجاع بيانات شخصية حسب المعرّف
 * - 'default' / 'character_default' / معرّف مفقود → شخصية النظام الثابتة (حماية ضد الفراغ)
 */
function getCharacterById(id) {
  if (!id || id === 'default' || id === 'character_default') {
    return DEFAULT_CHARACTER;
  }
  const list = (typeof STORE_ITEMS !== 'undefined' && STORE_ITEMS.characters) ? STORE_ITEMS.characters : [];
...
const STORE_ITEMS = {
  ...
  titles: [
    { id: 'title_explorer', price: 100, name: { ar: 'مستكشف الأساطير', en: 'Myth Explorer' }, color: '#3b82f6' },
    { id: 'title_shadow', price: 250, name: { ar: 'سيد الظلال', en: 'Shadow Lord' }, color: '#8b5cf6' },
    { id: 'title_dragon_tamer', price: 400, name: { ar: 'مروض التنانين', en: 'Dragon Tamer' }, color: '#ef4444' },
    { id: 'title_legend', price: 1000, name: { ar: 'أسطورة حية', en: 'Living Legend' }, color: '#fbbf24' }
  ],
  // 🌌 3. خلفيات الملف الشخصي (Banners)
  banners: [
    { id: 'banner_sunken_abyss_lighthouse', price: 700, name: { ar: 'منارة الهاوية الغارقة', en: 'Sunken Abyss Lighthouse' }, image: 'assets/images/store/banners/sunken_abyss_lighthouse.jpg' },
    { id: 'banner_dark_royal_sword', price: 700, name: { ar: 'السيف الملكي المظلم', en: 'Dark Royal Sword' }, image: 'assets/images/store/banners/dark_royal_sword.jpg' },
